...
function App() {
  ...
  // Update favicon when settings load
  useEffect(() => {
    if (settings?.logo) {
    ...
    <div className="app">
      ...
      <nav className="navbar">
        <div className="container nav-container">
          <div className="logo">
            <img className="sampras-logo" src={settings?.logo || "/estate-removebg-preview.png"} alt="Sampras Realty Group Logo" onError={(e) => {
          ...
          <ul className={`nav-links ${isMobileMenuOpen ? 'mobile-active' : ''}`}>
            ...
            <li><a href="/blog" className="nav-link" onClick={() => setIsMobileMenuOpen(false)}>Blog</a></li>
            <li><a href="/#contact" className="nav-link" onClick={() => setIsMobileMenuOpen(false)}>Contact</a></li>
          </ul>
          <a href={`tel:${settings.phone?.replace(/[^0-9+]/g, '')}`} className="nav-contact desktop-contact">
            <Phone size={20} />
            <span>{settings.phone || '+1 979 600 2124'}</span>
          </a>
      ...
      <section id="about" className="section">
        <div className="container">
          ...
          {/* Founder Section */}
          <div className="founder-section" style={{ marginTop: '6rem', display: 'flex', gap: '4rem', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            >
              <motion.h4 variants={fadeIn} className="hero-subtitle" style={{ fontSize: '1rem', marginBottom: '0.5rem', textAlign: 'left', marginLeft: 0 }}>Our Founder</motion.h4>
              <motion.h2 variants={fadeIn} style={{ fontSize: '2.5rem', color: 'var(--primary-green)', marginBottom: '1.5rem', lineHeight: '1.2' }}>{founderData?.title || 'Real Estate, Made Simple'}</motion.h2>
              <motion.p variants={fadeIn} style={{ fontSize: '1.1rem', color: '#516f90', marginBottom: '1.2rem', lineHeight: '1.7' }}>
                {founderData?.description1 || 'At Sampras, we believe the right home starts with the right guidance. We research communities, understand the market, and help you explore opportunities with confidence.'}
              </motion.p>
              <motion.p variants={fadeIn} style={{ fontSize: '1.1rem', color: '#516f90', marginBottom: '1.5rem', lineHeight: '1.7' }}>
                {founderData?.description2 || "Whether you're a first-time home buyer, a young couple, or looking for a new community, our team is here to guide you through every step — from finding the right property to understanding your financing options."}
              </motion.p>
              <motion.p variants={fadeIn} style={{ fontSize: '1.2rem', fontWeight: 'bold', color: 'var(--primary-green)', marginBottom: '2rem' }}>
                {founderData?.quote || 'Your goals. Our guidance. One step closer to home.'}
              </motion.p>
              <motion.div variants={fadeIn}>
                <a href="#contact" className="btn btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', fontWeight: 'bold', textDecoration: 'none' }}>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              style={{ flex: '1 1 40%', minWidth: '300px', position: 'relative' }}
            >
              <img 
                src={founderData?.image || "https://placehold.co/600x700/f5f7f6/113c2b?text=Founder+Image"} 
                alt="Our Founder" 
                style={{ width: '100%', borderRadius: '12px', border: '3px dashed #d1d5db', padding: '15px', position: 'relative', zIndex: 1, backgroundColor: 'white' }} 
              />
            </motion.div>
          ...
          <div className="contact-container">
            ...
            >
              ...
              <div className="form-group">
                ...
                <input type="text" name="subject" value={formData.subject} onChange={handleInputChange} className={`form-input ${formErrors.subject ? 'error' : ''}`} style={{ borderColor: formErrors.subject ? '#d9534f' : '' }} />
                {formErrors.subject && <span style={{ color: '#d9534f', fontSize: '0.85rem' }}>{formErrors.subject}</span>}
              </div>
              <div className="form-group">
                <label>Message</label>
                <textarea name="message" value={formData.message} onChange={handleInputChange} className="form-textarea"></textarea>
              </div>
            ...
            >
              ...
              <div className="contact-details">
                <p style={{ whiteSpace: 'pre-line' }}>{settings.address || '1234 Luxury Estate Blvd, Suite 100\nHouston, Texas 77002'}</p>
                
                <a href={`tel:${settings.phone?.replace(/[^0-9+]/g, '')}`} className="contact-detail-item" style={{ marginTop: '1.5rem', textDecoration: 'none' }}>
                  <Phone size={20} className="contact-detail-icon" />
                  <span>{settings.phone || '+1 979 600 2124'}</span>
                </a>
                <div className="contact-detail-item">
                  <Mail size={20} className="contact-detail-icon" />
                  <a href={`mailto:${settings.email || 'homes@samprasrealty.com'}`} style={{ color: 'var(--accent-gold)', textDecoration: 'none' }}>
                    {settings.email || 'homes@samprasrealty.com'}
                  </a>
                </div>
              </div>
              
              <div className="social-links">
                {settings.facebook && <a href={settings.facebook} className="social-icon" aria-label="Facebook"><svg xmlns="http://www.w3.org/0000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg></a>}
                {settings.twitter && <a href={settings.twitter} className="social-icon" aria-label="Twitter"><svg xmlns="http://www.w3.org/0000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg></a>}
                {settings.instagram && <a href={settings.instagram} className="social-icon" aria-label="Instagram"><svg xmlns="http://www.w3.org/0000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg></a>}
                {settings.linkedin && <a href={settings.linkedin} className="social-icon" aria-label="LinkedIn"><svg xmlns="http://www.w3.org/0000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg></a>}
              </div>
              
              <div className="map-container">
                <iframe src={settings.mapLocation || "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d110502.61185038317!2d-95.40129145000001!3d29.760426750000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640b8b4488d8501%3A0xca0d02def365053b!2sHouston%2C%20TX!5e0!3m2!1sen!2sus!4v1705608246328!5m2!1sen!2sus"} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
              </div>
            </motion.div>
          </div>
        </div>
